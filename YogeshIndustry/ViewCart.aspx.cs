...
namespace YogeshIndustry
{
    ...
    {
        Cart c;
        string cs = ConfigurationManager.ConnectionStrings["YogeshDbConnectionString1"].ConnectionString;
        ...
        protected void btnOrder_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Close();
                //details
                string orderdetails = "Your Order Details are as follows: <br>";
                orderdetails += "Orderid = " + orderid + "<br>";
              ...
              //  com1.Parameters.AddWithValue("@O_Id", orderid);
                ...
                orderdetails += "Order Date= " + DateTime.Now.ToString() + "<br>";
                ...
                foreach (CartItem item in c.Items)
                {
                  ...
                  //  Response.Write("Adding items to ordered table");
                    ...
                    orderdetails += "<br> ProductName " + productname;
                    orderdetails += "<br> Quantity " + quantity;
                    orderdetails += "<br> Price " + price;
                }
                ...
                try
                {
                    ...
                    {
                        emailMessage.From = new MailAddress("yogeshtextilesmumbai@gmail.com", "Yogesh Textiles");
                        ...
                        using (SmtpClient MailClient = new SmtpClient("smtp.gmail.com", 587))
                        {
                            ...
                            MailClient.Credentials = new System.Net.NetworkCredential("yogeshtextilesmumbai@gmail.com", "yogeshtextiles");
