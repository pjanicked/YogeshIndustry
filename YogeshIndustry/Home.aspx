			...
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
					<div class="about-heading">
						<h2>about</h2>
						<p>Yogesh Textiles is a newly found startup. We provide high quality textiles , global delivery and 24 X 7 support.</p>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="about-right" id="abt">
						...
						<div class="about-right-support">
							<div class="about-right-wrapper">
								...
								<p>Any suggestion? Any kno-how tips? Want to exchange?(that'll happen rarely though), We are here for you? Reach out for us anytime!</p>
							</div>
						</div>
